...
/*       |- [ ⚠ ] - CREDITOS DEL CODIGO - [ ⚠ ] -|      */
/*     —◉ DESAROLLADO POR Net:                       */
/*     ◉ Otosaka (https://github.com/net)          */
/*     ◉ Número: wa.me/529541853460                       */
/*                                                       */
/*     —◉ FT:                                            */
/*     ◉ Jdv (https://github.com/J-dev)  */
/*                                                       */
/* [❗]                      [❗]                      [❗] */
/* -------------------------------------------------------*/
...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuarás como un Bot de WhatsApp el cual fue creado por J-dev, tu seras Netfree_bot.`;
