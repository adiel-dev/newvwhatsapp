...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('529541853460-529541853460@g.us' ? {remoteJid: '529541853460-529541853460@g.us'} : {})}, message: {'videoMessage': {'title': '🔥Netfree - bot🔥', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '🧿 Netfree mx 🔮', 'jpegThumbnail': false}}};
